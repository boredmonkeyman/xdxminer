    ...
    public class PoolConfig
    {
        ...
        public static ObservableCollection<PoolConfig> GetETCPoolConfigs()
        {
            return new ObservableCollection<PoolConfig> {
                new PoolConfig() { id = 1, url = "solo-etc.2miners.com" ,port = 5050, isSSL =false} ,
                ...
                new PoolConfig { id = 5, url = "etc-eu1.nanopool.org" ,port = 10100, isSSL =false} ,
                new PoolConfig { id = 6, url = "etc-us-east1.nanopool.org" ,port = 10100, isSSL =false} ,
                new PoolConfig { id = 7, url = "etc-asia1.nanopool.org" ,port = 10100, isSSL =false} ,
